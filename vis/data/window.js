{
  ...
  devicePixelRatio: 1.2979999780654907;
  document: document;
  external: External;
  fetch: fetch();
  find: find();
  ...
  localStorage: {
    'OTelJS.ClientId' = "da13054f-7ced-423e-a7db-add3d4d1fcf5";
    length: 1
  };
  location: {
    href: 'http://192.168.1.3:5504/vis/visual2/vis2.html';
    ancestorOrigins: DOMStringList;
    origin: 'http://192.168.1.3:5504';
    host: '192.168.1.3'
  };
  ...
  outerHeight: 916;
  outerWidth: 1628;
  pageXOffset: 15.408320426940918;
  pageYOffset: 25.423728942871094;
  parent: Window;
  performance: {
    timeOrigin: 1589018656248.333;
    onresourcetimingbufferfull: null;
    memory: 'MemoryInfo';
    navigation: 'PerformanceNavigation';
    timing: 'PerformanceTimin'
  };
  ...
  scrollBy: scrollBy();
  scrollTo: scrollTo();
  scrollX: 15.408320426940918;
  scrollY: 25.423728942871094;
  self: Window;
  sessionStorage: {
  ...
  visualViewport: {
    offsetLeft: 0;
    offsetTop: 0;
    pageLeft: 15.408320426940918;
    pageTop: 25.423728942871094;
    width: 652.5423583984375
  };
