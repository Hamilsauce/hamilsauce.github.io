    ...
    Object.entries(entry)
      .forEach(([key, val], index, fields) => {
        ...
        if (index === fields.length - 1) {
          ...
          this.addcolumnId(actionCell, index)
          this.addClass(actionCell, 'action-field');
          const deleteRowButton = /*html*/ `<div class="row-action-button">
            <i class="button-icon deleteRowButton fas fa-trash"></i>
          </div>`;
          const filterRowButton = /*html*/ `<div class="row-action-button">
            <i class="button-icon filterRowButton fas fa-filter"></i>
          </div>`;
          const undoRowButton = /*html*/ `<div class="row-action-button">
            <i class="button-icon const undoRowButton fas fa-undo"></i>
          </div>`;
          const pinRowButton = /*html*/ `<div class="row-action-button pinButton">
