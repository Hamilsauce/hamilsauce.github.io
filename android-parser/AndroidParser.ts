...
/**
 *  USE THE JAVASCRIPT VERSION (AndroidParser.js) FOR RUNNING IN THE BROWSER IN index.html!
 */
...
//     const doc = new DOMParser().parseFromString(xmlString, type);
...
//     return this.createObjectGraph(this.parse(xmlString));
//   }

//   static graphFromDocument(xmlDocument = '') {
//     return this.createObjectGraph(xmlDocument);
//   }
// }
